...
public sealed partial class ShredderSystem : EntitySystem
{
    ...
    {
        if (_itemSlots.TryGetSlot(uid, BinSlotId, out var slot))
            comp.BinSlot = slot;
    ...
    private void OnBinSlotChanged(EntityUid uid, ShredderComponent comp, ContainerModifiedMessage args)
    {
        ...
        _appearance.SetData(uid, ShredderVisuals.BinPresent, _itemSlots.TryGetSlot(uid, BinSlotId, out var slot) && slot.HasItem);
    }
